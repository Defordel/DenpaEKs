...
class MainMenuState extends MusicBeatState {
	...
	override function create() {
		...
		prompt.active = false;
		add(prompt);
		var versionShit2:FlxText = new FlxText(6, FlxG.height - 64, 0, 'DenpaEx v${Main.denpaEngineVersion.version}', 12);
		...
		add(versionShit2);
		var versionShit3:FlxText = new FlxText(6, FlxG.height - 44, 0, 'DenpaEx Plus v${Main.denpaExEngineVersion.version}', 12);
